...
<body>
	...
	<!-- el 변환 오류  -->
	<%-- <h2>테스트</h2>
	<h3>${mem.getMid() }님이 ${mem.getBdate }에 작성한 글입니다.</h3> --%>

	<h2>글 수정/삭제하기</h2>
	<h3>"${mem.getMid() }"님이 작성한 글입니다.</h3>
	...
	<form action="control.jsp" method="post" name="form1">
		<input type="hidden" name="action" value="update"> <input
			type="hidden" name="bnum" value="<%=data.getBnum()%>"> <input
		...
		<table border="1">
			...
			<tr>
				...
				<td><input type="date" name="bdate"
					value="<%=data.getBdate()%>" disabled></td>
			</tr>
			<tr>
	...
	<br>
	<br>
	<a href="control.jsp?action=main">메인으로 돌아가가기</a>
